...
const CONTACTUS = () => {
  ...
  return (
    <div className="w-full relative bg-grayscale-white h-[2130px] overflow-hidden text-left text-lg text-black font-pacifico">
      <div className="absolute top-[0px] left-[calc(50%_-_720px)] bg-darkorange-500 w-[1440px] h-[94px] flex flex-row items-center justify-center py-[25px] px-[66px] box-border gap-[104px] text-sm text-grayscale-white font-segoe-ui">
